...
@section('content')
    ...
    <x-admin.table>
        ...
        <div class="px-5 py-3.5 border-b border-gray-100 dark:border-gray-700">
            <form method="GET" action="{{ route('admin.radius-users.index') }}" class="flex flex-wrap items-center gap-3">
                ...
                <div class="relative w-64">
                    ...
                    @if ($search)
                        <button type="button" onclick="this.closest('form').querySelector('[name=search]').value=''; this.closest('form').submit();"
                ...
                <div class="flex items-center gap-2">
                    ...
                    @if ($group || $search)
                        <a href="{{ route('admin.radius-users.index') }}"
                            class="inline-flex items-center gap-1 px-3 py-2 text-xs font-medium rounded-lg border border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
