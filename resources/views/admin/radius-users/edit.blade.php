            ...
            <form method="POST" action="{{ route('admin.radius-users.update', $user['username']) }}"
                ...
                <div>
                    ...
                    <input type="text" id="expiry" name="expiry"
                           value="{{ old('expiry', $user['expiry'] !== '-' ? $user['expiry'] : '') }}"
                    ...
                    <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">
                        Format: <code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded text-xs">DD Mon YYYY</code> — kosongkan untuk hapus expire.
                    </p>
                </div>
